...
client.once('ready', async () => {
    console.log(`${client.user.tag} is ready to play for ${client.guilds.cache.size} guilds!`);
...
client.on('interactionCreate', async interaction => {
    if (interaction.isCommand()) {
        ...
        try {
            ...
            await interaction.followUp({ content: `Wystąpił błąd, skontaktuj się z deweloperem podając ID błędu: [${id}]`, ephemeral: true });
        }
    }
});
